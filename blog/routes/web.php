...
Route::get('/cv', 'BlogController@cv');

Route::get('/tm', 'BlogController@tm');

// Route::get('bb', function () {return view ('blogBackup');});
...
Route::post('/createcomment', 'PostsController@createCommentForm')->name('comment.create');
